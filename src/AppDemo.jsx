...
function App() {
  ...
  const dalProductModalRef = useRef(null);
...
useEffect(() => {
  ...
  new Modal(dalProductModalRef.current,{
    backdrop: false
  });
},[])
...
const handleOpenProductModal = (mode, product) => {
  ...
  const modaInstance = Modal.getInstance(productModalRef.current);
  modaInstance.show();
}
...
const handleOpenDelProductModal = (product) => {
  ...
  const modaInstance = Modal.getInstance(dalProductModalRef.current);
  modaInstance.show();
}
